...
class BorderWidget(QWidget):
    ...
    def init_ui(self):
        ...
        checkbox.stateChanged.connect(lambda state: self.parent.toggle_gradient("borders", state))
        ...
        solid_color_preview.mousePressEvent = lambda event: self.parent.choose_solid_color("borders")
        ...
        self.color1_preview.mousePressEvent = lambda event: self.parent.choose_gradient_color("borders", 1)
        ...
        self.color2_preview.mousePressEvent = lambda event: self.parent.choose_gradient_color("borders", 2)
        ...
        angle_slider.valueChanged.connect(lambda angle: self.parent.update_gradient_angle("borders", angle))
        gradient_layout.addWidget(angle_slider)
        angle_spin = QSpinBox()
        angle_spin.setStyleSheet("background: transparent")
        angle_spin.setRange(0, 360)
        angle_spin.setSuffix('°')
        angle_spin.valueChanged.connect(lambda angle: self.parent.update_gradient_angle("borders", angle))
        ...
        self.parent.gradient_settings["borders"]['widgets'] = {
            'checkbox': checkbox,
        ...
        self.parent.toggle_gradient("borders", checkbox.isChecked())