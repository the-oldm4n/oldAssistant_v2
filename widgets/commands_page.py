...
class CommandsPage(QWidget):
    ...
    def init_ui(self):
        ...
        new_com_widget = CreateCommandsWidget(self.main, self)
        added_com_widget = CommandsWidget(self.main, self)
        process_links_widget = ProcessLinksWidget(self.main, self)
        create_scripts_widget = CreateScriptsWidget(self.main, self)
...
class CreateCommandsWidget(QWidget):
    ...
    def on_file_added(self, filepath):
        ...
        debuglog.info(f"Файл добавлен: {filepath}")
    
    def on_file_removed(self, filepath):
        """Конкретный файл удален"""
        debuglog.info(f"Файл удален: {filepath}")
...
class CreateScriptsWidget(QWidget):
    ...
    def create_forms(self):
        ...
        self.autostart_form = TaskSchedulerWidget(commands_manager=self.commands_manager, main=self.main)
...
class TaskSchedulerWidget(QWidget):
    def __init__(self, commands_manager=None, main=None, parent=None):
        super().__init__(parent)
        self.commands_manager = commands_manager
        self.main = main
